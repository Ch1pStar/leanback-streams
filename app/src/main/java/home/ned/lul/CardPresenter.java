...
public class CardPresenter extends Presenter {
    ...
    private static void updateCardBackgroundColor(ImageCardView view, boolean selected, int c) {
        int color;
        if(c == 0) {
            color = selected ? sSelectedBackgroundColor : sDefaultBackgroundColor;
        }else{
            color = c;
        }
